...
<head>
	...
	<!-- iCheck -->
	<link rel="stylesheet" href="<?= base_url(); ?>public/admin_assets/plugins/iCheck/square/blue.css">
...
<body class="hold-transition login-page">
	<div class="login-box">
		...
		<div class="login-box-body">
			...
			<?php echo form_open('admin/login/postLogin'); ?>
	...
	<!-- iCheck -->
	<script src="<?= base_url(); ?>public/admin_assets/plugins/iCheck/icheck.min.js"></script>
	<script>
		$(function() {
			$('input').iCheck({
